...
const Button: React.FC<ButtonProps> = ({
  ...
  const variants = {
    primary: 'bg-calamity text-white hover:bg-calamity/90 focus:ring-calamity',
    secondary: 'bg-sage text-white hover:bg-sage/90 focus:ring-sage',
    navy: 'bg-navy text-white hover:bg-navy/90 focus:ring-navy',
    outline: 'bg-transparent border border-calamity text-calamity hover:bg-calamity/5 focus:ring-calamity',
    ghost: 'bg-transparent text-navy hover:bg-navy/5 focus:ring-navy',
